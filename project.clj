(defproject hey-friend "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "hey-friend.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main hey-friend.server
  ...
  :cljsbuild {:builds
              {:app
               {:source-paths ["src/cljs"]
                ...
                ;; :figwheel {:on-jsload "hey-friend.core/on-figwheel-reload"}

                :compiler {:main hey-friend.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/hey_friend.js"
